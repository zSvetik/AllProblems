...
public class MainClass {
	...
	/**
	 * 
	 * Problem 9: Special Pythagorean triplet. A Pythagorean triplet is a set of
	...
	private static Long problem8() {
		String stringNumber = "";
		int group = 13;
		return LongStream.range(0, stringNumber.length() - group)
				.mapToObj(i -> stringNumber.substring((int) i).split("(?<=\\G.{" + group + "})"))
